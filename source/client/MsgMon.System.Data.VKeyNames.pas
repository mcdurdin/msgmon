unit MsgMon.System.Data.VKeyNames;

interface

const
  SVKeyNames: array[0..255] of string = (
  ...
  '0x0E',              // 0x0E : unassigned
  '0x0F',              // 0x0F : unassigned
  ...
  '0x3A',              // 0x3A : unassigned
  '0x3B',              // 0x3B : unassigned
  '0x3C',              // 0x3C : unassigned
  '0x3D',              // 0x3D : unassigned
  '0x3E',              // 0x3E : unassigned
  '0x3F',              // 0x3F : unassigned
